...
|---|---|---|---|
| v2.4.3 | 2026-05-08 | Restyle Month-End and Recon tabs to match Bosch aesthetic — scoped CSS overrides for cards, forms, buttons, upload zones, progress bars, SharePoint config; no HTML/JS changes. | `b01d41d` |
